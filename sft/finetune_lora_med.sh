...
torchrun --standalone --nnodes=1 --nproc_per_node=$nproc_per_node \
    ...
    data.train_files=medical_consultation/train_en_8068_all_format_filter_994_sft_w_thinking.parquet \
    data.val_files=medical_consultation/train_en_8068_all_format_filter_100_sft_w_thinking.parquet \
