...
MODEL_PATH=$1
OUTPUT_PREFIX=${2:-test_ai_hospital_en_output_multi_gpu_patientllm_iter}
...
for MAX_ITERATIONS in 10; do
    ...
    torchrun \
        ...
        ragen/env/medical_consultation/evaluation/AI-Hospital/inference_fast_for_patientllm_ai_hospital.py \
    ...
    OUTPUT_FILE="$MODEL_PATH/eval_ai_hospital_scores_patientllm_category_iter$MAX_ITERATIONS.json"
    ...
    torchrun --nproc_per_node=8 \
        --master_addr=127.0.0.1 \
        --master_port=$RANDOM_PORT \
        ragen/env/medical_consultation/evaluation/AI-Hospital/evaluation_for_patientllm_category_ai_hospital.py \
